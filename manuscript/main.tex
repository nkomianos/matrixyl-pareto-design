...
\textbf{Conclusion}: The Pareto frontier is stable under these perturbations. No candidate outside the original frontier enters the top three under any of the six $\pm 30\%$ variations, and the mean rank change averaged across the sweep is 0.25 positions. This stability suggests that K4P and the position-5 flexibility are features of the descriptor landscape, not artifacts of the particular weights we chose.
