...
\bottomrule
\end{tabular}
\caption{Radius of gyration (RoG), a one-number summary of molecular extent computed from 8-conformer RDKit ETKDG ensembles (Eq.~\ref{eq:rog}). Lower RoG indicates a more compact, diffusion-favorable conformation.}
\label{tab:rog}
\end{table}
