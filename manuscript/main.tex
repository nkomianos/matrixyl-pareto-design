...
\begin{enumerate}
  \item \textbf{Explicit control over objectives}: We can quantify both penetration (TPSA, $M_w$, LogP) and function (motif preservation, edit distance) simultaneously.
